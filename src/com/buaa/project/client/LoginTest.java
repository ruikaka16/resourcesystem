...
//****************************tree3**************************	
	...
	treeNode3_1_2_1.addListener(new TreeNodeListenerAdapter(){
			...
			public void onClick(Node Node, EventObject e ){
				...
				FormPanel formPanel_tn_3121 = new FormPanel();
			//	formPanel_tn_11.setLayout(new FitLayout());
				formPanel_tn_3121.setPaddings(5,5,5,0);
				formPanel_tn_3121.setFrame(true);
				formPanel_tn_3121.setLabelAlign(Position.TOP);
				...
				//TextField txtName_tn_3121 = new TextField("地址","address",100);
				//txtName_tn_3121.setLabel("地址");
				//DateField txtData_tn_3121 = new DateField("出生年月","birthday",100);
				...
				//formPanel_tn_3121.add(txtName_tn_3121);
				//formPanel_tn_3121.add(txtData_tn_3121);
				
				
				window_tn_3121.add(formPanel_tn_3121);
				window_tn_3121.show();
